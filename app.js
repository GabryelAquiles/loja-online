...
window.abrirModal = (nome, preco, imagensBase64, descEncoded) => {
    ...
    modal.innerHTML = `
        ...
        <div class="detail-container">
            <div class="carousel"><img src="${imagens[0]}"></div>
            <div class="product-data">
                <h1 style="font-weight:900; margin-bottom:10px;">${nome}</h1>
                <p style="font-size:1.5rem; margin-bottom:15px;">R$ ${preco}</p>
                <p style="color:#666;">${desc}</p>
                <button onclick="window.open('https://wa.me/${lojaConfig.whatsapp}?text=Interesse: ${nome}')">PEDIR VIA WHATSAPP</button>
            </div>
        </div>`;
